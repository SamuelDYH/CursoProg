public class CuentaBancaria {
    ...
    // El get sirve para obtener el valor de un atributo que se encuentra en privado
    ...
    public void setTitular(String titular){
        if (titular != null && !titular.isEmpty()) {
            ...
            System.out.println("Error: el titular no puede estat vacio. " );
        }
    }

    //Metodo para depositar dinero a la cuenta
    public void depositar(double monto){
        //Vereficamos que el mosto sea mayor a cero
        if (monto > 0) {
    ...
    public void retirar(double monto){
        if (monto > 0 && monto <= saldo) {
            ...
            System.out.println("Error no se pude retirar ese monto");
        }
    }
}
